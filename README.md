...
| <a name="input_max_session_duration"></a> [max\_session\_duration](#input\_max\_session\_duration) | Number of minutes before a session ends (default: infinite) [1-1440] | `number` | `-1` | no |
...
| <a name="output_iam_policy_arn"></a> [iam\_policy\_arn](#output\_iam\_policy\_arn) | IAM Policy for EC2 instances with access to SSM resources |
